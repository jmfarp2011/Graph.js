var d3_tree = Graph.Component.extend({
  name: 'd3_tree',
  render: function(obj){
  ...
  buildTree: function(obj){
    ...
    function update(source) {
      ...
      function click(d){ 
        $('#graph_component_d3_tree').off('mouseleave').off('mouseover');
        $('#graph_component_d3_tree_div').stop().slideUp('slow', function(){
          that.dashboard.bindFirst( {cid: d.cid} );
        });
      }
